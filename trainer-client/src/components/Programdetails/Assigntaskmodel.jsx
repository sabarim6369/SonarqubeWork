...
const[loading,setisloading]=useState(false);
  ...
  const handleManualSubmit = async () => {
    if (!programId || !qNo || !qName ||!qdescription|| manualTestCases.length === 0 || !manualdate) {
    ...
    try {
      ...
      setProgramDetails((prev)=>({
        ...prev,
        studentsManualTasks:[...prev.studentsManualTasks,newtask]
      }))
  ...
  return (
    <div className="fixed inset-0 bg-transparent bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-400 rounded-xl p-6 w-[700px] max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {manualTestCases.map((tc, index) => (
                <div
                  key={index}
                  className="mb-3 border rounded-lg p-3 space-y-2 bg-gray-400"
                >
                  <div>
                  ...
                  <div>
                    <label className="text-sm font-medium">Is Hidden?</label>
                    <select
                      ...
                      onChange={(e) =>
                        handleTestCaseChange(
                          index,
                          "isHidden",
                          e.target.value === "true" // correctly converts string to boolean
                        )
                      }
                      className="w-full px-3 py-2 border rounded-lg mt-1"
                    >
